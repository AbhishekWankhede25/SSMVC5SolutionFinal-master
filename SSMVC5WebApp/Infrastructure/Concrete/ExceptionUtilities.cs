...
namespace SSMVC5WebApp.Infrastructure.Concrete
{
    public class ExceptionUtilities
    {
        ...
        /// </summary>
        public static readonly Func<Exception, string> defaultFormatter = (ex) => (ex == null) ? string.Empty : ex.ToString();
        ...
        {
            {typeof(SqlException), (ex)=>FormSqlException(ex)}
        };

        private static string FormSqlException(Exception ex)
        {
        ...
        public static string FormatException(Exception ex, bool includeStackTrace = true, bool includeContext = false, int maxInnerExceptionDepth = 5)
        {
            if (ex == null)
                return String.Empty;
